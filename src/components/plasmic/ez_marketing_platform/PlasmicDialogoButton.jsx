...
import sty from "./PlasmicDialogoButton.module.css"; // plasmic-import: AwA9TQi9SmzV/css
...
export const PlasmicDialogoButton__VariantProps = new Array(
  "showStartIcon",
  "showEndIcon",
  "isDisabled",
  "shape",
...
export const PlasmicDialogoButton__ArgProps = new Array(
  "children",
  "startIcon",
  "endIcon",
  "link",
...
function PlasmicDialogoButton__RenderFunc(props) {
      ...
      {(hasVariant($state, "showStartIcon", "showStartIcon") ? true : false) ? (
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CheckSvgIcon
                className={classNames(projectcss.all, sty.svg__tEhGi)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <Icon38Icon
                className={classNames(projectcss.all, sty.svg__ebVa)}
                role={"img"}
              />
            ),
...
function makeNodeComponent(nodeName) {
    ...
    const { variants, args, overrides } = React.useMemo(
      () =>
        deriveRenderOpts(props, {
          ...
          internalArgPropNames: PlasmicDialogoButton__ArgProps,
          internalVariantPropNames: PlasmicDialogoButton__VariantProps
        }),
      [props, nodeName]
    );
    return PlasmicDialogoButton__RenderFunc({
      variants,
      args,
      overrides,
      forNode: nodeName
  ...
  if (nodeName === "root") {
    func.displayName = "PlasmicDialogoButton";
  } else {
    func.displayName = `PlasmicDialogoButton.${nodeName}`;
  }
  return func;
}

export const PlasmicDialogoButton = Object.assign(
  // Top-level PlasmicDialogoButton renders the root element
  makeNodeComponent("root"),
  {
    ...
    // Metadata about props expected for PlasmicDialogoButton
    internalVariantProps: PlasmicDialogoButton__VariantProps,
    internalArgProps: PlasmicDialogoButton__ArgProps,
    useBehavior
  }
);

export default PlasmicDialogoButton;
/* prettier-ignore-end */
