...
import sty from "./PlasmicCLogin.module.css"; // plasmic-import: CyfZEYzAmuED/css
...
export const PlasmicCLogin__VariantProps = new Array();

export const PlasmicCLogin__ArgProps = new Array(
  "eMailInput2",
  "passwordInput4"
);
...
function PlasmicCLogin__RenderFunc(props) {
      ...
      <div className={projectcss.plasmic_page_wrapper}>
        ...
        >
          ...
          >
            ...
            <div className={classNames(projectcss.all, sty.freeBox__bFZr)}>
              <UserSvgIcon
                className={classNames(projectcss.all, sty.svg__kmI0)}
                role={"img"}
              />
              ...
              {renderPlasmicSlot({
                defaultContents: (
                  <EmailInput
                    className={classNames(
                      "__wab_instance",
                      sty.emailInput__fkFpa
                    )}
                    endIcon={
                      <CheckSvgIcon
                        className={classNames(projectcss.all, sty.svg__yEyL1)}
                        role={"img"}
                      />
                    }
                  />
            ...
            <div className={classNames(projectcss.all, sty.freeBox__olaUs)}>
              <LockSvgIcon
                className={classNames(projectcss.all, sty.svg__pMKsE)}
                role={"img"}
              />
            ...
            >
              ...
              <PlasmicLink__
                ...
                onClick={async event => {
                  const $steps = {};
                  $steps["goToCCreateAccount"] = true
                    ? (() => {
                        const actionArgs = {
                          destination: `/c- create-account`
                        };
                        return (({ destination }) => {
                          if (
                    ...
                    : undefined;
                  if (
                    $steps["goToCCreateAccount"] != null &&
                    typeof $steps["goToCCreateAccount"] === "object" &&
                    typeof $steps["goToCCreateAccount"].then === "function"
                  ) {
                    $steps["goToCCreateAccount"] = await $steps[
                      "goToCCreateAccount"
                    ];
                  }
                }}
...
function makeNodeComponent(nodeName) {
    ...
    const { variants, args, overrides } = React.useMemo(
      () =>
        deriveRenderOpts(props, {
          ...
          internalArgPropNames: PlasmicCLogin__ArgProps,
          internalVariantPropNames: PlasmicCLogin__VariantProps
        }),
      [props, nodeName]
    );
    return PlasmicCLogin__RenderFunc({
      variants,
      args,
      overrides,
      forNode: nodeName
  ...
  if (nodeName === "root") {
    func.displayName = "PlasmicCLogin";
  } else {
    func.displayName = `PlasmicCLogin.${nodeName}`;
  }
  return func;
}

export const PlasmicCLogin = Object.assign(
  // Top-level PlasmicCLogin renders the root element
  makeNodeComponent("root"),
  {
    ...
    // Metadata about props expected for PlasmicCLogin
    internalVariantProps: PlasmicCLogin__VariantProps,
    internalArgProps: PlasmicCLogin__ArgProps,
    // Page metadata
    pageMetadata: {
      title: "Login",
      description: "",
