...
import sty from "./PlasmicLastInput.module.css"; // plasmic-import: EprmhitWo7Jg/css
...
export const PlasmicLastInput__VariantProps = new Array(
  "showStartIcon",
  "showEndIcon",
  "isDisabled",
  "color"
...
export const PlasmicLastInput__ArgProps = new Array(
  "string",
  "endIcon",
  "startIcon",
  "value",
...
function PlasmicLastInput__RenderFunc(props) {
    ...
    >
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <SearchSvgIcon
              className={classNames(projectcss.all, sty.svg__c1JB2)}
              role={"img"}
            />
          ),
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <CheckSvgIcon
              className={classNames(projectcss.all, sty.svg__tGPo)}
              role={"img"}
            />
          ),
...
function makeNodeComponent(nodeName) {
    ...
    const { variants, args, overrides } = React.useMemo(
      () =>
        deriveRenderOpts(props, {
          ...
          internalArgPropNames: PlasmicLastInput__ArgProps,
          internalVariantPropNames: PlasmicLastInput__VariantProps
        }),
      [props, nodeName]
    );
    return PlasmicLastInput__RenderFunc({
      variants,
      args,
      overrides,
      forNode: nodeName
  ...
  if (nodeName === "root") {
    func.displayName = "PlasmicLastInput";
  } else {
    func.displayName = `PlasmicLastInput.${nodeName}`;
  }
  return func;
}

export const PlasmicLastInput = Object.assign(
  // Top-level PlasmicLastInput renders the root element
  makeNodeComponent("root"),
  {
    ...
    // Metadata about props expected for PlasmicLastInput
    internalVariantProps: PlasmicLastInput__VariantProps,
    internalArgProps: PlasmicLastInput__ArgProps,
    useBehavior
  }
);

export default PlasmicLastInput;
/* prettier-ignore-end */
