...
import sty from "./PlasmicFirstInput.module.css"; // plasmic-import: Tf07dnmbURTH/css
...
export const PlasmicFirstInput__VariantProps = new Array(
  "showStartIcon",
  "showEndIcon",
  "isDisabled",
  "color"
...
export const PlasmicFirstInput__ArgProps = new Array(
  "string",
  "value",
  "name",
  "required",
...
function PlasmicFirstInput__RenderFunc(props) {
    ...
    >
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <SearchSvgIcon
              className={classNames(projectcss.all, sty.svg__zFkAd)}
              role={"img"}
            />
          ),
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <CheckSvgIcon
              className={classNames(projectcss.all, sty.svg__fd0Zk)}
              role={"img"}
            />
          ),
...
function makeNodeComponent(nodeName) {
    ...
    const { variants, args, overrides } = React.useMemo(
      () =>
        deriveRenderOpts(props, {
          ...
          internalArgPropNames: PlasmicFirstInput__ArgProps,
          internalVariantPropNames: PlasmicFirstInput__VariantProps
        }),
      [props, nodeName]
    );
    return PlasmicFirstInput__RenderFunc({
      variants,
      args,
      overrides,
      forNode: nodeName
  ...
  if (nodeName === "root") {
    func.displayName = "PlasmicFirstInput";
  } else {
    func.displayName = `PlasmicFirstInput.${nodeName}`;
  }
  return func;
}

export const PlasmicFirstInput = Object.assign(
  // Top-level PlasmicFirstInput renders the root element
  makeNodeComponent("root"),
  {
    ...
    // Metadata about props expected for PlasmicFirstInput
    internalVariantProps: PlasmicFirstInput__VariantProps,
    internalArgProps: PlasmicFirstInput__ArgProps,
    useBehavior
  }
);

export default PlasmicFirstInput;
/* prettier-ignore-end */
