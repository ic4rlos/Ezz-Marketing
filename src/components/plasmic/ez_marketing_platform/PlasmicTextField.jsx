...
import Label from "../../Label"; // plasmic-import: R2BAkQvruzH5/component
import TextInput from "../../TextInput"; // plasmic-import: 5b2dnQVBUEeV/component
import TextAreaInput from "../../TextAreaInput"; // plasmic-import: T5wDU4o3TJXe/component
import Description from "../../Description"; // plasmic-import: AtYC6UtrycZ0/component
...
import sty from "./PlasmicTextField.module.css"; // plasmic-import: _UguEbQ45zLp/css
...
function PlasmicTextField__RenderFunc(props) {
  ...
  return (
    ...
    >
      ...
      <div
        className={classNames(projectcss.all, sty.freeBox__xawZ4, {
          [sty.freeBoxiconEnd__xawZ4LExq]: hasVariant(
            $state,
            "iconEnd",
            "iconEnd"
          ),
          [sty.freeBoxiconStart__xawZ46ZQrl]: hasVariant(
            $state,
            "iconStart",
            "iconStart"
          ),
          [sty.freeBoxmultiLine__xawZ4VHoub]: hasVariant(
            $state,
            "multiLine",
            "multiLine"
          )
      ...
      >
        <div
          className={classNames(projectcss.all, sty.freeBox___28Qdb, {
            [sty.freeBoxiconStart___28Qdb6ZQrl]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            ),
            [sty.freeBoxmultiLine___28QdbvHoub]: hasVariant(
              $state,
              "multiLine",
              "multiLine"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg__htGjW)}
                role={"img"}
              />
            ),
        ...
        <div
          className={classNames(projectcss.all, sty.freeBox__ovei0, {
            [sty.freeBoxiconEnd__ovei0LExq]: hasVariant(
              $state,
              "iconEnd",
              "iconEnd"
            ),
            [sty.freeBoxiconStart__ovei06ZQrl]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg__ss7Wa)}
                role={"img"}
              />
            ),
