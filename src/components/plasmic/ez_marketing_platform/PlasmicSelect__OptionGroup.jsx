...
import sty from "./PlasmicSelect__OptionGroup.module.css"; // plasmic-import: _6ALV23Ag4jE/css
import SUPER__PlasmicSelect from "./PlasmicSelect"; // plasmic-import: iuUTkEsiQBLB/render
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              <Select__Option
                className={classNames("__wab_instance", sty.option__nMcHt)}
              >
                <div
                  className={classNames(
                    projectcss.all,
              ...
              <Select__Option
                className={classNames("__wab_instance", sty.option__qYlgw)}
              >
                <div
                  className={classNames(
                    projectcss.all,
