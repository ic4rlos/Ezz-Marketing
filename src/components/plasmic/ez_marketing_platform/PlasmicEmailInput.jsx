...
import sty from "./PlasmicEmailInput.module.css"; // plasmic-import: N6jiyqjMi6tf/css
...
export const PlasmicEmailInput__VariantProps = new Array(
  "showStartIcon",
  "showEndIcon",
  "isDisabled",
  "color"
...
export const PlasmicEmailInput__ArgProps = new Array(
  "string",
  "endIcon",
  "startIcon",
  "value",
...
function PlasmicEmailInput__RenderFunc(props) {
    ...
    >
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <SearchSvgIcon
              className={classNames(projectcss.all, sty.svg__oIHyH)}
              role={"img"}
            />
          ),
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <CheckSvgIcon
              className={classNames(projectcss.all, sty.svg__hfQ0H)}
              role={"img"}
            />
          ),
...
function makeNodeComponent(nodeName) {
    ...
    const { variants, args, overrides } = React.useMemo(
      () =>
        deriveRenderOpts(props, {
          ...
          internalArgPropNames: PlasmicEmailInput__ArgProps,
          internalVariantPropNames: PlasmicEmailInput__VariantProps
        }),
      [props, nodeName]
    );
    return PlasmicEmailInput__RenderFunc({
      variants,
      args,
      overrides,
      forNode: nodeName
  ...
  if (nodeName === "root") {
    func.displayName = "PlasmicEmailInput";
  } else {
    func.displayName = `PlasmicEmailInput.${nodeName}`;
  }
  return func;
}

export const PlasmicEmailInput = Object.assign(
  // Top-level PlasmicEmailInput renders the root element
  makeNodeComponent("root"),
  {
    ...
    // Metadata about props expected for PlasmicEmailInput
    internalVariantProps: PlasmicEmailInput__VariantProps,
    internalArgProps: PlasmicEmailInput__ArgProps,
    useBehavior
  }
);

export default PlasmicEmailInput;
/* prettier-ignore-end */
