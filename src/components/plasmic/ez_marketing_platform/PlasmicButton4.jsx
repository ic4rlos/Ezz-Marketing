...
import sty from "./PlasmicButton4.module.css"; // plasmic-import: Yuxa95wIKkuN/css
import CircleIcon from "./icons/PlasmicIcon__Circle"; // plasmic-import: 71nXQxWpb_nm/icon
import ChevronDownIcon from "./icons/PlasmicIcon__ChevronDown"; // plasmic-import: 5euUjx6Nl4Lt/icon

createPlasmicElementProxy;

export const PlasmicButton4__VariantProps = new Array(
  "color",
  "type",
  "size",
  "iconStart",
  ...
  return (
    ...
    >
      ...
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__oBTf, {
          [sty.freeBoxcolor_neutral__oBTfnJvEm]: hasVariant(
            $state,
            "color",
            "neutral"
          ),
          [sty.freeBoxcolor_white__oBTfhEq1N]: hasVariant(
            $state,
            "color",
            "white"
          ),
          [sty.freeBoxroundedFull__oBTfz5A5D]: hasVariant(
            $state,
            "roundedFull",
            "roundedFull"
          ),
          [sty.freeBoxsize_extraLarge__oBTfLcy9X]: hasVariant(
            $state,
            "size",
            "extraLarge"
          ),
          [sty.freeBoxsize_extraSmall__oBTfOpsA]: hasVariant(
            $state,
            "size",
            "extraSmall"
          ),
          [sty.freeBoxsize_large__oBTfuQmec]: hasVariant(
            $state,
            "size",
            "large"
          ),
          [sty.freeBoxsize_small__oBTfsYc9]: hasVariant(
            $state,
            "size",
            "small"
          ),
          [sty.freeBoxtype_bordered__oBTf9OOmh]: hasVariant(
            $state,
            "type",
            "bordered"
          ),
          [sty.freeBoxtype_bordered_color_success__oBTf9OOmhBpLyy]:
            hasVariant($state, "color", "success") &&
            hasVariant($state, "type", "bordered")
        })}
      >
        <div
          className={classNames(projectcss.all, sty.freeBox__sMtru, {
            [sty.freeBoxcolor_neutral__sMtruNJvEm]: hasVariant(
              $state,
              "color",
              "neutral"
            ),
            [sty.freeBoxcolor_neutral_type_soft__sMtruNJvEmQubEo]:
              hasVariant($state, "color", "neutral") &&
              hasVariant($state, "type", "soft"),
            [sty.freeBoxiconStart__sMtrucJXyw]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            ),
            [sty.freeBoxsize_extraLarge__sMtruLcy9X]: hasVariant(
              $state,
              "size",
              "extraLarge"
            ),
            [sty.freeBoxsize_large__sMtruUQmec]: hasVariant(
              $state,
              "size",
              "large"
            ),
            [sty.freeBoxsize_small__sMtruSYc9]: hasVariant(
              $state,
              "size",
              "small"
            ),
            [sty.freeBoxtype_bordered__sMtru9OOmh]: hasVariant(
              $state,
              "type",
              "bordered"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg__f6OuL)}
                role={"img"}
              />
            ),
        ...
        <div
          className={classNames(projectcss.all, sty.freeBox__gVux3, {
            [sty.freeBoxiconEnd__gVux3DDdk1]: hasVariant(
              $state,
              "iconEnd",
              "iconEnd"
            ),
            [sty.freeBoxsize_extraLarge__gVux3Lcy9X]: hasVariant(
              $state,
              "size",
              "extraLarge"
            ),
            [sty.freeBoxsize_large__gVux3UQmec]: hasVariant(
              $state,
              "size",
              "large"
            ),
            [sty.freeBoxsize_small__gVux3SYc9]: hasVariant(
              $state,
              "size",
              "small"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <ChevronDownIcon
                className={classNames(projectcss.all, sty.svg__vXuAj)}
                role={"img"}
              />
            ),
