...
import sty from "./PlasmicButton5.module.css"; // plasmic-import: YFvkKgUA8D1_/css
...
export const PlasmicButton5__VariantProps = new Array(
  "color",
  "type",
  "size",
  "iconStart",
  ...
  return (
    ...
    >
      ...
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__eriMm, {
          [sty.freeBoxcolor_neutral__eriMm5Hb1R]: hasVariant(
            $state,
            "color",
            "neutral"
          ),
          [sty.freeBoxcolor_success_type_bordered__eriMm4Q677RSCI]:
            hasVariant($state, "color", "success") &&
            hasVariant($state, "type", "bordered"),
          [sty.freeBoxroundedFull__eriMmKjV9Q]: hasVariant(
            $state,
            "roundedFull",
            "roundedFull"
          ),
          [sty.freeBoxsize_extraLarge__eriMm2CfXj]: hasVariant(
            $state,
            "size",
            "extraLarge"
          ),
          [sty.freeBoxsize_extraSmall__eriMmloplA]: hasVariant(
            $state,
            "size",
            "extraSmall"
          ),
          [sty.freeBoxsize_large__eriMm2R560]: hasVariant(
            $state,
            "size",
            "large"
          ),
          [sty.freeBoxsize_small__eriMmlQw6]: hasVariant(
            $state,
            "size",
            "small"
          ),
          [sty.freeBoxtype_bordered__eriMmrSCI]: hasVariant(
            $state,
            "type",
            "bordered"
          )
      ...
      >
        <div
          className={classNames(projectcss.all, sty.freeBox__debxc, {
            [sty.freeBoxcolor_neutral__debxc5Hb1R]: hasVariant(
              $state,
              "color",
              "neutral"
            ),
            [sty.freeBoxcolor_neutral_type_soft__debxc5Hb1RPJrKb]:
              hasVariant($state, "color", "neutral") &&
              hasVariant($state, "type", "soft"),
            [sty.freeBoxiconStart__debxcILdz]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            ),
            [sty.freeBoxsize_extraLarge__debxc2CfXj]: hasVariant(
              $state,
              "size",
              "extraLarge"
            ),
            [sty.freeBoxsize_large__debxc2R560]: hasVariant(
              $state,
              "size",
              "large"
            ),
            [sty.freeBoxsize_small__debxclQw6]: hasVariant(
              $state,
              "size",
              "small"
            ),
            [sty.freeBoxtype_bordered__debxcrSCI]: hasVariant(
              $state,
              "type",
              "bordered"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg__lb4Ke)}
                role={"img"}
              />
            ),
        ...
        <div
          className={classNames(projectcss.all, sty.freeBox__uanHq, {
            [sty.freeBoxiconEnd__uanHqLkH4F]: hasVariant(
              $state,
              "iconEnd",
              "iconEnd"
            ),
            [sty.freeBoxsize_extraLarge__uanHq2CfXj]: hasVariant(
              $state,
              "size",
              "extraLarge"
            ),
            [sty.freeBoxsize_large__uanHq2R560]: hasVariant(
              $state,
              "size",
              "large"
            ),
            [sty.freeBoxsize_small__uanHqlQw6]: hasVariant(
              $state,
              "size",
              "small"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <ChevronDownIcon
                className={classNames(projectcss.all, sty.svg___9Bxr0)}
                role={"img"}
              />
            ),
