...
import sty from "./PlasmicLikeButton.module.css"; // plasmic-import: l8BBGM3OPB72/css
...
export const PlasmicLikeButton__VariantProps = new Array(
  "showStartIcon",
  "showEndIcon",
  "isDisabled",
  "shape",
    ...
    >
      {(hasVariant($state, "showStartIcon", "showStartIcon") ? true : false) ? (
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CheckSvgIcon
                className={classNames(projectcss.all, sty.svg__nivns)}
                role={"img"}
              />
            ),
      ...
      <div
        ...
        className={classNames(projectcss.all, sty.contentContainer, {
          ...
          [sty.contentContainercolor_softGreen]: hasVariant(
            $state,
            "color",
            "softGreen"
          ),
          [sty.contentContainercolor_softRed]: hasVariant(
            $state,
            "color",
            "softRed"
          ),
      ...
      {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <Icon38Icon
                className={classNames(projectcss.all, sty.svg__en8Ez)}
                role={"img"}
              />
            ),
