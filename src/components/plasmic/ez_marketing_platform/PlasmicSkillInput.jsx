...
import sty from "./PlasmicSkillInput.module.css"; // plasmic-import: lahcYCVZ0ES5/css
...
export const PlasmicSkillInput__VariantProps = new Array(
  "showStartIcon",
  "showEndIcon",
  "isDisabled",
  "color"
...
export const PlasmicSkillInput__ArgProps = new Array(
  "string",
  "endIcon",
  "startIcon",
  "value",
...
function PlasmicSkillInput__RenderFunc(props) {
    ...
    >
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <SearchSvgIcon
              className={classNames(projectcss.all, sty.svg___9Axj5)}
              role={"img"}
            />
          ),
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <CheckSvgIcon
              className={classNames(projectcss.all, sty.svg__qIw2P)}
              role={"img"}
            />
          ),
...
function makeNodeComponent(nodeName) {
    ...
    const { variants, args, overrides } = React.useMemo(
      () =>
        deriveRenderOpts(props, {
          ...
          internalArgPropNames: PlasmicSkillInput__ArgProps,
          internalVariantPropNames: PlasmicSkillInput__VariantProps
        }),
      [props, nodeName]
    );
    return PlasmicSkillInput__RenderFunc({
      variants,
      args,
      overrides,
      forNode: nodeName
  ...
  if (nodeName === "root") {
    func.displayName = "PlasmicSkillInput";
  } else {
    func.displayName = `PlasmicSkillInput.${nodeName}`;
  }
  return func;
}

export const PlasmicSkillInput = Object.assign(
  // Top-level PlasmicSkillInput renders the root element
  makeNodeComponent("root"),
  {
    ...
    // Metadata about props expected for PlasmicSkillInput
    internalVariantProps: PlasmicSkillInput__VariantProps,
    internalArgProps: PlasmicSkillInput__ArgProps,
    useBehavior
  }
);

export default PlasmicSkillInput;
/* prettier-ignore-end */
