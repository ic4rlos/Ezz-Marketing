...
import sty from "./PlasmicPlusButton.module.css"; // plasmic-import: acaccHtQ5A9k/css
...
export const PlasmicPlusButton__VariantProps = new Array(
  "showStartIcon",
  "showEndIcon",
  "isDisabled",
  "shape",
...
export const PlasmicPlusButton__ArgProps = new Array(
  "link",
  "submitsForm",
  "target",
  "startIcon",
...
function PlasmicPlusButton__RenderFunc(props) {
      ...
      {(hasVariant($state, "showStartIcon", "showStartIcon") ? true : false) ? (
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CheckSvgIcon
                className={classNames(projectcss.all, sty.svg__ekZm2)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant($state, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <Icon38Icon
                className={classNames(projectcss.all, sty.svg__mClto)}
                role={"img"}
              />
            ),
...
function makeNodeComponent(nodeName) {
    ...
    const { variants, args, overrides } = React.useMemo(
      () =>
        deriveRenderOpts(props, {
          ...
          internalArgPropNames: PlasmicPlusButton__ArgProps,
          internalVariantPropNames: PlasmicPlusButton__VariantProps
        }),
      [props, nodeName]
    );
    return PlasmicPlusButton__RenderFunc({
      variants,
      args,
      overrides,
      forNode: nodeName
  ...
  if (nodeName === "root") {
    func.displayName = "PlasmicPlusButton";
  } else {
    func.displayName = `PlasmicPlusButton.${nodeName}`;
  }
  return func;
}

export const PlasmicPlusButton = Object.assign(
  // Top-level PlasmicPlusButton renders the root element
  makeNodeComponent("root"),
  {
    ...
    // Metadata about props expected for PlasmicPlusButton
    internalVariantProps: PlasmicPlusButton__VariantProps,
    internalArgProps: PlasmicPlusButton__ArgProps,
    useBehavior
  }
);

export default PlasmicPlusButton;
/* prettier-ignore-end */
