...
import sty from "./PlasmicGraduationInput.module.css"; // plasmic-import: maAnhl2FQPIf/css
...
export const PlasmicGraduationInput__VariantProps = new Array(
  "showStartIcon",
  "showEndIcon",
  "isDisabled",
  "color"
...
export const PlasmicGraduationInput__ArgProps = new Array(
  "string",
  "endIcon",
  "startIcon",
  "value",
...
function PlasmicGraduationInput__RenderFunc(props) {
    ...
    >
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <SearchSvgIcon
              className={classNames(projectcss.all, sty.svg___43NsU)}
              role={"img"}
            />
          ),
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <CheckSvgIcon
              className={classNames(projectcss.all, sty.svg__wRp87)}
              role={"img"}
            />
          ),
...
function makeNodeComponent(nodeName) {
    ...
    const { variants, args, overrides } = React.useMemo(
      () =>
        deriveRenderOpts(props, {
          ...
          internalArgPropNames: PlasmicGraduationInput__ArgProps,
          internalVariantPropNames: PlasmicGraduationInput__VariantProps
        }),
      [props, nodeName]
    );
    return PlasmicGraduationInput__RenderFunc({
      variants,
      args,
      overrides,
      forNode: nodeName
  ...
  if (nodeName === "root") {
    func.displayName = "PlasmicGraduationInput";
  } else {
    func.displayName = `PlasmicGraduationInput.${nodeName}`;
  }
  return func;
}

export const PlasmicGraduationInput = Object.assign(
  // Top-level PlasmicGraduationInput renders the root element
  makeNodeComponent("root"),
  {
    ...
    // Metadata about props expected for PlasmicGraduationInput
    internalVariantProps: PlasmicGraduationInput__VariantProps,
    internalArgProps: PlasmicGraduationInput__ArgProps,
    useBehavior
  }
);

export default PlasmicGraduationInput;
/* prettier-ignore-end */
