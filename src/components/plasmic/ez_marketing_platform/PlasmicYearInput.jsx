...
import sty from "./PlasmicYearInput.module.css"; // plasmic-import: enq6tuh1OWCG/css
...
export const PlasmicYearInput__VariantProps = new Array(
  "showStartIcon",
  "showEndIcon",
  "isDisabled",
  "color"
...
export const PlasmicYearInput__ArgProps = new Array(
  "string",
  "endIcon",
  "startIcon",
  "value",
...
function PlasmicYearInput__RenderFunc(props) {
    ...
    >
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <SearchSvgIcon
              className={classNames(projectcss.all, sty.svg__hPLo)}
              role={"img"}
            />
          ),
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <CheckSvgIcon
              className={classNames(projectcss.all, sty.svg__wVt64)}
              role={"img"}
            />
          ),
...
function makeNodeComponent(nodeName) {
    ...
    const { variants, args, overrides } = React.useMemo(
      () =>
        deriveRenderOpts(props, {
          ...
          internalArgPropNames: PlasmicYearInput__ArgProps,
          internalVariantPropNames: PlasmicYearInput__VariantProps
        }),
      [props, nodeName]
    );
    return PlasmicYearInput__RenderFunc({
      variants,
      args,
      overrides,
      forNode: nodeName
  ...
  if (nodeName === "root") {
    func.displayName = "PlasmicYearInput";
  } else {
    func.displayName = `PlasmicYearInput.${nodeName}`;
  }
  return func;
}

export const PlasmicYearInput = Object.assign(
  // Top-level PlasmicYearInput renders the root element
  makeNodeComponent("root"),
  {
    ...
    // Metadata about props expected for PlasmicYearInput
    internalVariantProps: PlasmicYearInput__VariantProps,
    internalArgProps: PlasmicYearInput__ArgProps,
    useBehavior
  }
);

export default PlasmicYearInput;
/* prettier-ignore-end */
