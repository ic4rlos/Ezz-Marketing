...
import sty from "./PlasmicVarian.module.css"; // plasmic-import: N6jiyqjMi6tf/css
...
export const PlasmicVarian__VariantProps = new Array(
  "showStartIcon",
  "showEndIcon",
  "isDisabled",
  "color"
...
export const PlasmicVarian__ArgProps = new Array(
  "string",
  "endIcon",
  "startIcon",
  "value",
...
function PlasmicVarian__RenderFunc(props) {
...
function makeNodeComponent(nodeName) {
    ...
    const { variants, args, overrides } = React.useMemo(
      () =>
        deriveRenderOpts(props, {
          ...
          internalArgPropNames: PlasmicVarian__ArgProps,
          internalVariantPropNames: PlasmicVarian__VariantProps
        }),
      [props, nodeName]
    );
    return PlasmicVarian__RenderFunc({
      variants,
      args,
      overrides,
      forNode: nodeName
  ...
  if (nodeName === "root") {
    func.displayName = "PlasmicVarian";
  } else {
    func.displayName = `PlasmicVarian.${nodeName}`;
  }
  return func;
}

export const PlasmicVarian = Object.assign(
  // Top-level PlasmicVarian renders the root element
  makeNodeComponent("root"),
  {
    ...
    // Metadata about props expected for PlasmicVarian
    internalVariantProps: PlasmicVarian__VariantProps,
    internalArgProps: PlasmicVarian__ArgProps,
    useBehavior
  }
);

export default PlasmicVarian;
/* prettier-ignore-end */
