...
import sty from "./PlasmicUniversityInput.module.css"; // plasmic-import: 6x4MI_4XrKVn/css
...
export const PlasmicUniversityInput__VariantProps = new Array(
  "showStartIcon",
  "showEndIcon",
  "isDisabled",
  "color"
...
export const PlasmicUniversityInput__ArgProps = new Array(
  "string",
  "endIcon",
  "startIcon",
  "value",
...
function PlasmicUniversityInput__RenderFunc(props) {
    ...
    >
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <SearchSvgIcon
              className={classNames(projectcss.all, sty.svg__ipE9)}
              role={"img"}
            />
          ),
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <CheckSvgIcon
              className={classNames(projectcss.all, sty.svg___1QGm)}
              role={"img"}
            />
          ),
...
function makeNodeComponent(nodeName) {
    ...
    const { variants, args, overrides } = React.useMemo(
      () =>
        deriveRenderOpts(props, {
          ...
          internalArgPropNames: PlasmicUniversityInput__ArgProps,
          internalVariantPropNames: PlasmicUniversityInput__VariantProps
        }),
      [props, nodeName]
    );
    return PlasmicUniversityInput__RenderFunc({
      variants,
      args,
      overrides,
      forNode: nodeName
  ...
  if (nodeName === "root") {
    func.displayName = "PlasmicUniversityInput";
  } else {
    func.displayName = `PlasmicUniversityInput.${nodeName}`;
  }
  return func;
}

export const PlasmicUniversityInput = Object.assign(
  // Top-level PlasmicUniversityInput renders the root element
  makeNodeComponent("root"),
  {
    ...
    // Metadata about props expected for PlasmicUniversityInput
    internalVariantProps: PlasmicUniversityInput__VariantProps,
    internalArgProps: PlasmicUniversityInput__ArgProps,
    useBehavior
  }
);

export default PlasmicUniversityInput;
/* prettier-ignore-end */
